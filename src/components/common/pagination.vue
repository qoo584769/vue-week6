<template>
  <div class="page">
    <button class="btn btn-secondary px-3 py-1 m-2" :disabled="props.PageData.data.has_pre == false"
    ...
    <button class="btn btn-secondary px-3 py-1 m-2" :disabled="props.PageData.data.has_next == false"
